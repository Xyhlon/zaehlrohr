...
Zählrohr gelangt, was bei \SI{316}{V} der Fall war. Nun wird die Spannung in kontinuierlich erhöht und die entsprechenden Counts
...
Um die Enpunktsenergie zu bestimmen wird der Aufbau aus \autoref{aufbau_Magnetfeldspektrometer} realisiert.
Als radioaktive Quelle wird erneut NA-22 in die dafür vorgesehene Halterung gesteckt. Nun wird die Betriebsspannung des
...
\autoref{tab:endpunktsenergie} aufgelistet.

%\label{tab:endpunktsenergie}
