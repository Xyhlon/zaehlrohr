...
Standardabweichung $\sigma$ vom Messreihensatz.}
...
\begin{table}[H]
  \caption{Dies sind die errechneten Energien $E$ und des Impulse $p$ beim
    Magnetspektrometer. Mit Daten aus \autoref{tab:magnetspektrometer} und der
    ...
    erstellt:\\
    $E \dots$ ist die Energie $beta$-Strahlung\\
    $p \dots$ ist der Impuls $beta$-Strahlung\\
}
...
Zerfällen $n$ über den Impulsen $p$ und Energien $E$ ein Energiespektrogramm
erstellen.
...
Die eingezeichneten Werten werden nun hier nochmals übersichtlich in der
