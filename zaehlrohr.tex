...
werden. \(\beta^-\)-Zerfall wird durch die Umwandlung eines Neutrons in ein Proton 
hervorgerufen, wodurch ein Elektron und ein Elektron-Antineutrino ausgestoßen werden, um 
die Erhaltungssätze nicht zu verletzen. \(\beta^+\)-Zerfall kommt in der Natur seltener 
vor, funktioniert aber nach dem
...
Hier werden die durch eine Superposition von 2 Exponentialfunktionen, der Experimentatoren gefitteten
...
\begin{figure}[H]
    ...
    \ch{Al} bei $\beta$-Strahlung. In diesem Diagramm ist $D$ die Dicke 
    der Aluminiumplatte und $z$ ist die Zählrate der
    durchdrungenen Teilchen. Dies wurde durch eine Superposition von 2 Exponentialfunktionen von den Experimentatoren
		gefittet.
...
\begin{figure}[H]
	...
	\caption[Doppelt-logarithmische Darstellung der Absorptionskurve von \ch{Al} bei
		...
		$z$ ist die Zählrate der durchdrungenen Teilchen. Dies wurde durch
...
qualitativ mit denen des Betreuer überein und beide entsprechen den Energien von
Übergängen der Zerfallsreihe von \ch{_{88}^{226}Ra}. Die 
\SI{700(60)}{\kilo\electronvolt} entsprechen einem \ch{^{214}Pb} Übergang und die 
\SI{2.32(16)}{\mega\electronvolt} entsprechen einem  \ch{^{214}Bi} Übergang.
