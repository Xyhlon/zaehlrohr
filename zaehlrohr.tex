...
\begin{table}[H]
  ...
  \begin{center}
    \input{./figures/messreihe_absorption_qal_raw.tex}
  \end{center}
\end{table}
...
Als radioaktive Quelle wird erneut \ch{^{22}_{11}Na} in die dafür vorgesehene Halterung gesteckt. 
Nun wird die Betriebsspannung des Netzgerätes so lange gesenkt, bis durch den Digitalzähler kein
Geräusch hörbar ist, was anzeigt, dass keine Strahlung auf das Zählrohr gelangt, was bei 
\SI{316}{\volt} der Fall war. Nun wird die Spannung in kontinuierlich erhöht, bis ein Wert von 
...
\begin{table}[H]
  ...
  \begin{center}
    \input{./figures/messreihe_charakter_raw.tex}
  \end{center}
\end{table}
...
\begin{table}[H]
  ...
  \begin{center}
    \input{./figures/messreihe_statistik_raw.tex}
  \end{center}
\end{table}
...
\begin{table}[H]
  ...
  \begin{center}
    \input{./figures/messreihe_abstand_raw.tex}
  \end{center}
\end{table}
...
\begin{table}[H]
  ...
  \begin{center}
    \input{./figures/messreihe_magneto_raw.tex}
  \end{center}
\end{table}
...
das zu vermessende \ch{^{226}_{88}Ra} verwendet. auch diese Werte werden auf den Computer übertragen und 
den zuvor erzeugten Plot bei einer Laufzeit von \SI{2400}{\second} beigefügt. Anhand des zuvor
bestimmten Referenzspektums können nun die Peaks des \ch{^{226}_{88}Ra} Spektrums vermessen werden.
